...
export interface ChatSendResult {
  ...
  /**
   * @deprecated
   * Legacy accepted-receipt replay only. New turns do not create or consume annotation IDs.
   */
