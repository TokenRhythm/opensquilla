...
const LEGACY_CODE_ALIASES: Readonly<Record<string, ArtifactProductErrorCode>> = {
  EDIT_SESSION_RENEWAL_REQUIRED: 'DOCUMENT_EDITING_RETIRED',
  ...
  ARTIFACT_EDIT_SESSION_EXPIRED: 'DOCUMENT_EDITING_RETIRED',
  ARTIFACT_EDIT_SESSION_STALE: 'DOCUMENT_EDITING_RETIRED',
  ARTIFACT_EDIT_SESSION_CONFLICT: 'DOCUMENT_EDITING_RETIRED',
