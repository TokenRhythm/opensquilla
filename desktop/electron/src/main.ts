...
const DESKTOP_MESSAGES: Record<DesktopLocale, Record<string, string>> = {
  en: {
    ...
    'onboarding.step2.tokenrhythmCtaExternalLabel': 'Claim ¥68 in free TokenRhythm tokens (opens in external browser)',
  ...
  ja: {
    ...
    'onboarding.step2.tokenrhythmCtaExternalLabel': 'TokenRhythmの68元相当の無料Tokenを受け取る（外部ブラウザーで開きます）',
  ...
  fr: {
    ...
    'onboarding.step2.tokenrhythmCtaExternalLabel': 'Obtenir 68 ¥ de tokens TokenRhythm gratuits (s’ouvre dans le navigateur externe)',
  ...
  de: {
    ...
    'onboarding.step2.tokenrhythmCtaExternalLabel': '68 ¥ kostenlose TokenRhythm-Token erhalten (wird im externen Browser geöffnet)',
  ...
  es: {
    ...
    'onboarding.step2.tokenrhythmCtaExternalLabel': 'Obtener 68 ¥ en tokens gratis de TokenRhythm (se abre en el navegador externo)',
