...
# Prepare a detached watchdog before the old uninstaller removes the current
# installation. If this installer is killed after that point, the watchdog
# restores the saved files and registry entries after the parent exits.
Call OpenSquillaPrepareUpdateRecovery
!insertmacro OpenSquillaMarkUpdateRecoveryPhase "uninstalling"
...
!insertmacro OpenSquillaMarkUpdateRecoveryPhase "extracting"
Call OpenSquillaRecoveryPauseIfRequested
...
!endif
Call OpenSquillaCommitUpdateRecovery
