...
try {
  ...
  assert.equal(
    ...
    'rgb(182, 80, 28)',
    'the registration call to action should use the light-theme strike accent',
  )
  ...
  assert.equal(
    ...
    'rgb(182, 80, 28)',
    'the free status should use the same light-theme strike accent as the provider promotion',
  )
  if (screenshotPath) {
