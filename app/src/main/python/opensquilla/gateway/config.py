...
class SquillaRouterConfig(BaseSettings):
    ...
    # Android builds do not ship the desktop V4 ML artifact/ONNX runtime.
    # Keep the built-in heuristic router active without making doctor readiness
    # fail; an explicit user setting can still opt into strict runtime checks.
