...
const props = defineProps<{
  ...
  // catalog carries no presets 鈥?the card simply doesn't render).
...
function activationActionLabel(
  ...
  return `${action} 鈥?${provider.label}`
}
      ...
      >
        ...
        >
          ...
          >
            ...
            > 路 {{ probeTiming(provider.providerId, 'firstResponseMs') }}</span>
            <span
              v-if="probeTiming(provider.providerId, 'totalMs')"
              class="setup-provider-card__probe-timing"
            > 路 {{ probeTiming(provider.providerId, 'totalMs') }}</span>
          </span>
        </button>
        <div class="setup-provider-card__actions">
          <button
            ...
            :aria-label="`${configuredTestLabel(provider)} 鈥?${provider.label}`"
          ...
          <button
            ...
            :aria-label="`${t('setup.provider.removeConfirmPrimary')} 鈥?${provider.label}`"
        ...
        >
          ...
          >
            ...
            <div class="setup-provider-modal__body">
              ...
              >
                ...
                <section class="setup-provider-modal__endpoint">
                  ...
                  >
                    {{ customFetching ? '鈥? : t('setup.provider.customModelsFetch') }}
                  </button>
            ...
            <footer v-if="customFormVisible" class="setup-provider-modal__footer">
              ...
              >{{ customCreating ? '鈥? : t('setup.provider.saveChanges') }}</button>
            </footer>
