...
def _binding(method: str) -> GatewayContractBinding[Any]:
    ...
    def validate(result: Any) -> Any:
        try:
            ...
            raise SkillManagementContractError(
    ...
    return GatewayContractBinding(
        ...
        result_validation_errors=(SkillManagementContractError,),
...
_BINDINGS: Final = {
    method: _binding(method) for method in SKILL_MANAGEMENT_CONTRACT_METHODS
}
