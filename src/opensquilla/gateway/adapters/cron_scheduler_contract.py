...
def _binding(method: str) -> GatewayContractBinding[Any]:
    ...
    def validate(result: Any) -> Any:
        try:
            ...
            raise CronSchedulerContractError(
    ...
    return GatewayContractBinding(
        ...
        result_validation_errors=(CronSchedulerContractError,),
...
_BINDINGS: Final = {method: _binding(method) for method in CRON_SCHEDULER_CONTRACT_METHODS}
