"""Generated Contract bindings for AgentCatalog Gateway methods."""
...
class AgentCatalogContractError(ValueError):
    """A successful AgentCatalog response violated its generated Contract."""
...
def _binding(method: str) -> GatewayContractBinding[Any]:
    ...
    def validate(result: Any) -> Any:
        try:
            ...
            raise AgentCatalogContractError(
    ...
    return GatewayContractBinding(
        ...
        result_validation_errors=(AgentCatalogContractError,),
...
_BINDINGS: Final = {method: _binding(method) for method in AGENT_CATALOG_CONTRACT_METHODS}


def register_agent_catalog_contract[ContextT, ResultT](
