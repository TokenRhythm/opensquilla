...
def _binding(method: str) -> GatewayContractBinding[Any]:
    ...
    def validate(result: Any) -> Any:
        try:
            ...
            raise PendingInputQueueContractError(
    ...
    return GatewayContractBinding(
        ...
        result_validation_errors=(PendingInputQueueContractError,),
...
_BINDINGS: Final = {method: _binding(method) for method in PENDING_INPUT_QUEUE_CONTRACT_METHODS}
