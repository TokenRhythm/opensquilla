"""Generated Contract bindings for turn admission Gateway methods."""
...
TURN_ADMISSION_CONTRACT_METHODS: Final = (
    "chat.send",
    "chat.abort",
    "sessions.send",
    "sessions.abort",
...
class TurnAdmissionContractError(ValueError):
    """A successful turn response violated its generated Contract."""
...
def _binding(method: str) -> GatewayContractBinding[Any]:
    ...
    def validate(result: Any) -> Any:
        try:
            ...
            raise TurnAdmissionContractError(
    ...
    return GatewayContractBinding(
        ...
        result_validation_errors=(TurnAdmissionContractError,),
...
_BINDINGS: Final = {method: _binding(method) for method in TURN_ADMISSION_CONTRACT_METHODS}


def register_turn_admission_contract[ContextT, ResultT](
