"""Generated Contract registration for runtime observability methods."""
...
class ObservabilityContractError(ValueError):
    """A successful observability response violated its generated Contract."""
...
def _binding(method: str) -> GatewayContractBinding[Any]:
    ...
    return GatewayContractBinding(
        ...
        result_validation_errors=(ObservabilityContractError,),
...
_BINDINGS: Final = {
    method: _binding(method) for method in OBSERVABILITY_CONTRACT_METHODS
}


def register_observability_contract[ContextT, ResultT](
