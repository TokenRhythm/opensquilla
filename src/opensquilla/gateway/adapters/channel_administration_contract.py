...
def _binding(method: str) -> GatewayContractBinding[Any]:
    ...
    def validate(result: Any) -> Any:
        try:
            ...
            raise ChannelAdministrationContractError(
    ...
    return GatewayContractBinding(
        ...
        result_validation_errors=(ChannelAdministrationContractError,),
...
_BINDINGS: Final = {
    method: _binding(method) for method in CHANNEL_ADMINISTRATION_CONTRACT_METHODS
}
