"""Shared history cursor types and failures."""
...
class HistoryCursorInvalidError(ValueError):
    """Raised when a non-empty cursor is not valid wire input."""


class HistoryCursorInvalidatedError(RuntimeError):
    """Raised when a parsed cursor does not anchor the requested session."""
