...
@pytest.mark.asyncio
async def test_doctor_memory_status_unavailable_includes_checkpoint_health():
    res = await get_dispatcher().dispatch(
...
@pytest.mark.asyncio
async def test_doctor_memory_status_reports_checkpoint_hash_mismatch(tmp_path):
