...
@pytest.mark.parametrize(
    ...
    [
        ...
        "desktop/electron/scripts/capture-windows-native-stacks.ps1",
        "desktop/electron/scripts/windows-native-stack-diagnostics.mjs",
        "desktop/electron/scripts/test-windows-native-stack-diagnostics.mjs",
