...
MIGRATION_ID = "V038__document_resources"
...
def test_v038_upgrades_v037_and_enforces_resource_occurrence_constraints(
    tmp_path: Path,
) -> None:
...
def test_v038_rolls_back_only_document_resource_objects(tmp_path: Path) -> None:
    db_path = tmp_path / "sessions.db"
