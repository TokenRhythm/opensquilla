...
MIGRATION_ID = "V035__artifact_mutation_attempts"


def _apply_through_v034(db_path: Path) -> None:
...
def test_v035_upgrades_v034_profile_and_enforces_receipt_constraints(tmp_path: Path) -> None:
    db_path = tmp_path / "sessions.db"
    _apply_through_v034(db_path)
...
def test_v035_rolls_back_only_mutation_attempt_receipts(tmp_path: Path) -> None:
    db_path = tmp_path / "sessions.db"
