...
MIGRATION_ID = "V036__document_resources"


def _apply_through_v035(db_path: Path) -> None:
...
def test_v036_upgrades_v035_and_enforces_resource_occurrence_constraints(
    tmp_path: Path,
) -> None:
    db_path = tmp_path / "sessions.db"
    _apply_through_v035(db_path)
...
def test_v036_rolls_back_only_document_resource_objects(tmp_path: Path) -> None:
    db_path = tmp_path / "sessions.db"
