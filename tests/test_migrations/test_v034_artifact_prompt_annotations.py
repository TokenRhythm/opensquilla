...
MIGRATION_ID = "V034__artifact_prompt_annotations"


def test_v034_creates_prompt_annotation_constraints_and_indexes(tmp_path: Path) -> None:
...
def test_v034_rolls_back_only_prompt_annotations(tmp_path: Path) -> None:
    db_path = tmp_path / "sessions.db"
