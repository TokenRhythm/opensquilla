...
_EXPECTED_CAPS: dict[tuple[str, str, str], tuple[bool, bool, bool, str]] = {
    ...
    ("orcarouter", "totally-unknown-model-x1", ""): (False, True, False, "none"),
    ("orcarouter", "orcarouter/auto", ""): (False, True, False, "none"),
    ("orcarouter", "anthropic/claude-sonnet-5", ""): (False, True, True, "none"),
    ("orcarouter", "openai/gpt-5.5", ""): (False, True, True, "none"),
    ("orcarouter", "deepseek/deepseek-v4-pro", ""): (False, False, False, "none"),
