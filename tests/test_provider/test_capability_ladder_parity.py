...
_EXPECTED_CAPS: dict[tuple[str, str, str], tuple[bool, bool, bool, str]] = {
    ...
    ("ionet", "totally-unknown-model-x1", ""): (False, True, False, "none"),
    ("ionet", "gpt-4o", ""): (False, True, True, "none"),
    ("ionet", "deepseek-r1", ""): (False, False, False, "none"),
    ("ionet", "glm-4.6", ""): (False, True, False, "none"),
    ("ionet", "qwen3-max", ""): (False, True, False, "none"),
    ("ionet", "qwen2.5-14b-instruct", ""): (False, True, False, "none"),
    ("ionet", "kimi-k2.5", ""): (False, True, True, "none"),
    ("ionet", "kimi-latest", ""): (False, True, False, "none"),
    ("ionet", "doubao-seed-1-6-251015", ""): (False, True, False, "none"),
    ("ionet", "seed-1-8-flash", ""): (False, True, False, "none"),
    ("ionet", "model-x-thinking", ""): (False, True, False, "none"),
    ("ionet", "gemini-2.5-flash", ""): (False, True, True, "none"),
    ("ionet", "gemini-3-pro-preview", ""): (False, True, True, "none"),
    ("ionet", "o3-mini", ""): (False, True, False, "none"),
    ("ionet", "gpt-5.5", ""): (False, True, True, "none"),
