...
_EXPECTED_CAPS: dict[tuple[str, str, str], tuple[bool, bool, bool, str]] = {
    ...
    ("opper", "totally-unknown-model-x1", ""): (False, True, False, "none"),
    ("opper", "claude-sonnet-4-6", ""): (False, True, True, "none"),
    ("opper", "gpt-5.5", ""): (False, True, True, "none"),
    ("opper", "gemini-3.8-flash", ""): (False, True, False, "none"),
