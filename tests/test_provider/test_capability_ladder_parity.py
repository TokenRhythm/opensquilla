...
_EXPECTED_CAPS: dict[tuple[str, str, str], tuple[bool, bool, bool, str]] = {
    ...
    ("requesty", "totally-unknown-model-x1", ""): (False, True, False, "none"),
    ("requesty", "gpt-4o", ""): (False, True, True, "none"),
    ("requesty", "deepseek-r1", ""): (False, False, False, "none"),
    ("requesty", "glm-4.6", ""): (False, True, False, "none"),
    ("requesty", "qwen3-max", ""): (False, True, False, "none"),
    ("requesty", "qwen2.5-14b-instruct", ""): (False, True, False, "none"),
    ("requesty", "kimi-k2.5", ""): (False, True, True, "none"),
    ("requesty", "kimi-latest", ""): (False, True, False, "none"),
    ("requesty", "doubao-seed-1-6-251015", ""): (False, True, False, "none"),
    ("requesty", "seed-1-8-flash", ""): (False, True, False, "none"),
    ("requesty", "model-x-thinking", ""): (False, True, False, "none"),
    ("requesty", "gemini-2.5-flash", ""): (False, True, True, "none"),
    ("requesty", "gemini-3-pro-preview", ""): (False, True, True, "none"),
    ("requesty", "o3-mini", ""): (False, True, False, "none"),
    ("requesty", "gpt-5.5", ""): (False, True, True, "none"),
