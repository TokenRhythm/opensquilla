...
def _default_aux(
    *,
    ...
    return _AgentConfigAuxiliaries(
        ...
        compaction_anchor_enabled=False,
        compaction_fallback_summary_max_tokens=3000,
        compaction_previous_summary_max_tokens=2000,
        compaction_total_summary_max_tokens=5000,
